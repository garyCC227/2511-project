...
public class BoardGenerator {
    ...
    public Board generate() {
        ...
        // randomly generate vehicles position
        populateBoard(newBoard);
        // bfs the board to generate puzzle
    ...
    /*
     * rule to make board more difficult - col 3 will always have a size 4 or 3
     * vehicle, chance to get 4 > get 3 - col 5 will always have a size 3 or 4
     * vehicle, chance to get 3 > get 4 - other col will have different probability
     * for size 2, 3 ,4
     */
