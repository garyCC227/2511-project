...
public class MenuController {
	...
	public void initialize(/*ActionEvent event*/) throws Exception {
		...
		startPic.setImage(new Image("/start.png", 70, 90, true, true));
		musicPic.setImage(new Image("/music.png", 70, 90, true, true));
		helpPic.setImage(new Image("/help.png", 70, 90, true, true));
